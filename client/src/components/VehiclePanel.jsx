        ...
        return (
          <div
            ...
            onClick={() => {
              ...
              setVehicle({ type: partner.vehicleType, image: partner.image });
            }}
            className="flex w-full items-center mb-2 justify-between p-4 border-2 border-gray-300 hover:shadow-lg active:border-black rounded-lg cursor-pointer transition-all"
          >
            ...
            <p className="text-xl font-semibold">₹{partner.fare}</p>
          </div>
        );
      })}
    </div>
